        ...
        <div className="flex flex-col justify-center py-14 md:pr-16 xl:pr-40 md:py-0">
          <div className="text-center md:text-left space-y-6">
            ...
            <motion.h1
              ...
              initial="hidden"
              animate="visible"
              className="text-5xl font-semibold lg:text-6xl dark:text-textColor-dark !leading-tight"
            >
              Find Your Perfect{" "}
              <span className="text-primary dark:text-primary-dark">Tutor</span>
            </motion.h1>
            <motion.p
            ...
            >
              We help you find perdect tutor for 1-on-1 lessons. It is
            ...
            >
              ...
              <button className="flex justify-end items-center gap-2 font-semibold">
                ...
                <span className="dark:text-textColor-dark">
                  See how it works
                </span>
              </button>
            </motion.div>
